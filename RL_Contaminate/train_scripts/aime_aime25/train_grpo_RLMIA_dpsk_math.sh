...
export EXP_NAME="deepseek-math-7b-instruct-openr1_aime_easy"
...
python3 -m verl.mix_src.main_mix_ppo \
    ...
    data.train_files=$DATA_DIR/openr1_aime_mia/openr1_aime_easy.parquet \
    ...
    actor_rollout_ref.rollout.max_prefix_len=3072 \
